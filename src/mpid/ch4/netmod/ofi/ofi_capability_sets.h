...
#ifdef DISABLE_SCALABLE_EP
#undef MPIDI_OFI_ENABLE_SCALABLE_ENDPOINTS
#define MPIDI_OFI_ENABLE_SCALABLE_ENDPOINTS MPIDI_OFI_OFF
#endif

#ifdef DISABLE_SHARED_CTX
#undef MPIDI_OFI_ENABLE_SHARED_CONTEXTS
#define MPIDI_OFI_ENABLE_SHARED_CONTEXTS MPIDI_OFI_OFF
#endif

#ifdef ENABLE_OFI_AUTO_PROGRESS
#define MPIDI_OFI_ENABLE_DATA_AUTO_PROGRESS MPIDI_OFI_ON
#define MPIDI_OFI_ENABLE_CONTROL_AUTO_PROGRESS MPIDI_OFI_ON
#endif
