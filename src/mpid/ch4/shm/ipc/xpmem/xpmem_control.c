...
int MPIDI_IPC_xpmem_send_lmt_rts_cb_hook(MPIDI_SHM_ctrl_hdr_t * ctrl_hdr)
{
    ...
    MPIR_Comm *root_comm;
    MPIR_FUNC_VERBOSE_STATE_DECL(MPID_STATE_MPIDI_IPC_XPMEM_CTRL_SEND_LMT_RTS_CB);
    MPIR_FUNC_VERBOSE_ENTER(MPID_STATE_MPIDI_IPC_XPMEM_CTRL_SEND_LMT_RTS_CB);
  ...
  fn_exit:
    MPIR_FUNC_VERBOSE_EXIT(MPID_STATE_MPIDI_IPC_XPMEM_CTRL_SEND_LMT_RTS_CB);
    return mpi_errno;
  fn_fail:
    goto fn_exit;
}

int MPIDI_IPC_xpmem_ctrl_send_lmt_cts_cb(MPIDI_SHM_ctrl_hdr_t * ctrl_hdr)
{
    int mpi_errno = MPI_SUCCESS;
    MPIR_Request *sreq;
    ...
    MPIR_FUNC_VERBOSE_STATE_DECL(MPID_STATE_MPIDI_IPC_XPMEM_CTRL_SEND_LMT_CTS_CB);
    MPIR_FUNC_VERBOSE_ENTER(MPID_STATE_MPIDI_IPC_XPMEM_CTRL_SEND_LMT_CTS_CB);
  ...
  fn_exit:
    MPIR_FUNC_VERBOSE_EXIT(MPID_STATE_MPIDI_IPC_XPMEM_CTRL_SEND_LMT_CTS_CB);
    return mpi_errno;
  fn_fail:
    goto fn_exit;
}

int MPIDI_IPC_xpmem_ctrl_send_lmt_cnt_free_cb(MPIDI_SHM_ctrl_hdr_t * ctrl_hdr)
{
    ...
    MPIR_FUNC_VERBOSE_STATE_DECL(MPID_STATE_MPIDI_IPC_XPMEM_CTRL_SEND_LMT_CNT_FREE_CB);
    MPIR_FUNC_VERBOSE_ENTER(MPID_STATE_MPIDI_IPC_XPMEM_CTRL_SEND_LMT_CNT_FREE_CB);
  ...
  fn_exit:
    MPIR_FUNC_VERBOSE_EXIT(MPID_STATE_MPIDI_IPC_XPMEM_CTRL_SEND_LMT_CNT_FREE_CB);
    return mpi_errno;
  fn_fail:
    goto fn_exit;
}
